...
Note 1: This listed CC1101 module requires 3.3V as opposed to the Arduino Pro Mini's 5V, hence the 3.3V Buck Converter.
Note 2: The Waveshare LCD can use 3.3V or 5V, but the Arduino Pro Mini 3.3V implements an 8 MHz clock compared with the 5V's 16 MHz clock. In testing, the 8 MHz clock appeared too slow to meet our processing requirements.
