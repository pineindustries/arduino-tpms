...
- [Adafruit TLV62569 3.3V Buck Converter Breakout](https://www.adafruit.com/product/4711)\
  Required to convert the Arduino's 5V on-board power to 3.3V for the CC1101.
...
- **Modulation**: ASK/OOK
- **Encoding**: Manchester
- **Packet Length**: 96 Bits, 80 bits less sync pattern
### Packet Structure:
```
Byte: 0... 4... 8... 12
      SSSU UUAA AAPT C
